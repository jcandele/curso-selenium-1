...
public class Ejercicio5 {
	...
	public static void main(String[] args) {
        ...
        WebElement dateBirthday = driver.findElement(By.xpath("//input[@id='dateOfBirthInput']"));
        ...
        WebElement hobbies = driver.findElement(By.xpath("//*[text()='Sports']")); // Como no tiene id el elemento superpuesto se usa XPATH
        hobbies.click();
        ...
        WebElement buttonClose = driver.findElement(By.xpath("//button[@id='closeLargeModal']"));
        buttonClose.click();
