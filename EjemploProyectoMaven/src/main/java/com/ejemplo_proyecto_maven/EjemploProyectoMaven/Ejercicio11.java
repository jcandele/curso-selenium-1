...
public class Ejercicio11 {
	...
	public static void main(String[] args) {
		...
		// Rellenar el formlario usando xpath para localizar el label de los campos y luego rellenarlos
        ...
        //WebElement firstName = driver.findElement(By.xpath("//label[text()='Name']//following::input[1]"));
        ...
        //WebElement lastName = driver.findElement(By.xpath("//label[text()='Name']//following::input[2]"));
        lastName.sendKeys(stringLastName);
        WebElement email = driver.findElement(By.xpath("//label[text()='Email']//following::input[@placeholder='name@example.com']"));
        ...
        WebElement gender = driver.findElement(By.xpath("//*[text()='Gender']//following::label[text()='" + stringGender + "']")); // Como no tiene id el elemento superpuesto se usa XPATH
        ...
        WebElement mobileNumber = driver.findElement(By.xpath("//label[text()='Mobile']//following::input[1]"));
        //WebElement mobileNumber = driver.findElement(By.xpath("//label[text()='Mobile']//following::input[@placeholder='Mobile Number']"));
        mobileNumber.sendKeys(stringMobile); // 10 dígitos
        
        // Seleccionar en datepicker
        WebElement dateBirthday = driver.findElement(By.xpath("//label[text()='Date of Birth']//following::input[1]"));
        ...
        WebElement subjects = driver.findElement(By.xpath("//label[text()='Subjects']//following::input[1]"));
        //new Actions(driver).moveToElement(subjects).perform(); // para mover el puntero (mouse) al elemento localizado
        subjects.sendKeys(stringSubjects);
        
        // Cargar un archivo
        WebElement upload_file = driver.findElement(By.xpath("//label[text()='Picture']//following::input[1]"));
        ...
        WebElement hobbies = driver.findElement(By.xpath("//label[text()='Hobbies']//following::label[text()='" + stringHobbies + "']")); // Como no tiene id el elemento superpuesto se usa XPATH
        //WebElement hobbies = driver.findElement(By.xpath("//label[text()='Hobbies']//following::label[3]"));
        hobbies.click();
        
        WebElement currentAdress = driver.findElement(By.xpath("//label[text()='Current Address']//following::textarea[@placeholder='Current Address']"));
        currentAdress.sendKeys(stringCurrentAddress);
        
        WebElement state = driver.findElement(By.xpath("//label[text()='State and City']//following::input[1]"));
        state.sendKeys(stringState);
        state.sendKeys(Keys.TAB);
        
        WebElement city = driver.findElement(By.xpath("//label[text()='State and City']//following::input[2]"));
