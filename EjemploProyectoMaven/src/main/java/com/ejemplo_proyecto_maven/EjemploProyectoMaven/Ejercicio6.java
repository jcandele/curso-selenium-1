...
public class Ejercicio6 {
	...
	public static void main(String[] args) {
        ...
        WebElement gender = driver.findElement(By.xpath("//*[text()='Gender']//following::label[text()='Other']")); // Como no tiene id el elemento superpuesto se usa XPATH
        ...
        WebElement hobbies = driver.findElement(By.xpath("//label[text()='Hobbies']//following::label[text()='Music']")); // Como no tiene id el elemento superpuesto se usa XPATH
